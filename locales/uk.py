...
STRINGS: dict[str, str] = {
    ...
    "invite.pick_space": "👥 До якого простору хочеш запросити?",
    "invite.pick_role": "🔑 Яку роль отримає запрошений?\n\n<b>Редактор</b> — може створювати і редагувати задачі\n<b>Переглядач</b> — тільки перегляд",
    "invite.role_editor": "✏️ Редактор",
    "invite.role_viewer": "👁 Переглядач",
    "invite.cancel_btn": "❌ Скасувати",
    "invite.no_owned_spaces": "У тебе ще немає власних просторів.\n\nСтвори простір через /spaces.",
    "invite.create_failed": "❌ Не вдалось створити запрошення. Спробуй ще раз.",
    "invite.created": (
        "✅ Запрошення створено!\n\n"
        "Роль: <b>{role}</b>\n\n"
        "Надішли це посилання тому, кого хочеш запросити:\n\n"
        "📱 <b>Через Telegram (рекомендовано):</b>\n"
        "<code>{tg_link}</code>\n\n"
        "🌐 <b>Через web:</b>\n"
        "<code>{web_link}</code>\n\n"
