...
STRINGS: dict[str, str] = {
    ...
    "common.unknown_command": "Не зрозумів. Використай /help щоб побачити доступні команди.",
    ...
    "task.list_footer": "Використай /done щоб завершити задачу.",
    "task.done_usage": "Використання: /done &lt;id_задачі&gt;\nПриклад: /done 42",
    "task.done_pick_prompt": "✅ Яку задачу ти виконав(ла)?",
    "task.done_success": "✅ Задачу #{id} виконано!",
    "task.done_failed": "❌ Не вдалось завершити задачу #{id}. Перевір ID і спробуй знову.",
    "task.done_requested": "✋ Запит надіслано! Чекаю підтвердження від батьків.",
    "task.done_approved_parent": "✅ Задачу #{id} підтверджено як виконану!",
    "task.done_rejected_parent": "❌ Виконання задачі #{id} відхилено.",
    "task.done_approved_child": "✅ Батьки підтвердили твою задачу! Молодець! 🎉",
    "task.done_rejected_child": "❌ Батьки поки не підтвердили. Продовжуй роботу 💪",
    "task.done_approve_failed": "❌ Не вдалось підтвердити. Спробуй ще раз.",
    ...
    "kids.footer": "Використай /done щоб завершити задачу.",
    ...
    # /tonight sections
    "daily.section_schedule": "Мій розклад:",
    "daily.section_kids": "Діти:",
    "daily.section_events": "Події завтра:",
    "daily.section_tasks": "Задачі:",
    "daily.child_tasks_count": "задач: {n}",
    "daily.child_blocked_count": "заблоковано: {n}",
    "daily.status_in_progress": "🔄 В процесі",
    "daily.status_blocked": "🔥 Заблоковано",
    "daily.status_todo": "📝 Todo",
    "daily.status_backlog": "📦 Беклог (≤7д)",
    "daily.status_done": "✅ Виконано",
    "daily.no_active_tasks": "🎉 Активних задач немає!",
    # Status transitions
    "daily.pick_new_status": "Змінити статус на:",
    "daily.no_transitions": "Немає доступних переходів.",
    "daily.to_todo": "📝 → Todo",
    "daily.to_in_progress": "🔄 → В процесі",
    "daily.to_blocked": "🔥 → Заблоковано",
    "daily.to_done": "✅ → Виконано",
    "daily.status_updated": "✅ Статус → {status}",
    "daily.scheduled_tomorrow": "📅 Заплановано на завтра ({date})",
    "daily.update_failed": "❌ Не вдалось оновити. Спробуй ще раз.",
    ...
    "event.remind_prompt": "🔔 Нагадати про подію?",
    "event.remind_15_btn": "15 хв",
    "event.remind_30_btn": "30 хв",
    "event.remind_60_btn": "1 година",
    "event.remind_skip_btn": "Пропустити",
