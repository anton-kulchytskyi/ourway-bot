...
STRINGS: dict[str, str] = {
    ...
    "task.list_footer": "Use /done to complete a task.",
    "task.done_usage": "Usage: /done &lt;task_id&gt;\nExample: /done 42",
    "task.done_pick_prompt": "✅ Which task did you complete?",
    "task.done_success": "✅ Task #{id} marked as done!",
    "task.done_failed": "❌ Could not complete task #{id}. Check the ID and try again.",
    "task.done_requested": "✋ Done request sent! Waiting for parent approval.",
    "task.done_approved_parent": "✅ Task #{id} approved as done!",
    "task.done_rejected_parent": "❌ Task #{id} completion rejected.",
    "task.done_approved_child": "✅ Your task was approved! Great job! 🎉",
    "task.done_rejected_child": "❌ Your task completion was not approved. Keep working on it 💪",
    "task.done_approve_failed": "❌ Could not approve. Please try again.",
    ...
    "kids.footer": "Use /done to complete a task.",
    ...
    # /tonight sections
    "daily.section_schedule": "My Schedule:",
    "daily.section_kids": "Kids:",
    "daily.section_events": "Tomorrow's Events:",
    "daily.section_tasks": "Tasks:",
    "daily.child_tasks_count": "tasks: {n}",
    "daily.child_blocked_count": "blocked: {n}",
    "daily.status_in_progress": "🔄 In Progress",
    "daily.status_blocked": "🔥 Blocked",
    "daily.status_todo": "📝 Todo",
    "daily.status_backlog": "📦 Backlog (≤7d)",
    "daily.status_done": "✅ Done",
    "daily.no_active_tasks": "🎉 No active tasks!",
    # Status transitions
    "daily.pick_new_status": "Change status to:",
    "daily.no_transitions": "No available transitions.",
    "daily.to_todo": "📝 → Todo",
    "daily.to_in_progress": "🔄 → In Progress",
    "daily.to_blocked": "🔥 → Blocked",
    "daily.to_done": "✅ → Done",
    "daily.status_updated": "✅ Status → {status}",
    "daily.scheduled_tomorrow": "📅 Scheduled for tomorrow ({date})",
    "daily.update_failed": "❌ Failed to update. Please try again.",
    ...
    "event.remind_prompt": "🔔 Add a reminder for this event?",
    "event.remind_15_btn": "15 min",
    "event.remind_30_btn": "30 min",
    "event.remind_60_btn": "1 hour",
    "event.remind_skip_btn": "Skip",
